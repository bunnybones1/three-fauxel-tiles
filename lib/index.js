...
var NoiseKit = class extends RTKit {
  ...
  constructor(edgeSize) {
    ...
    const opacityUniform = new Uniform2(1);
...
var velocityField_frag_default = "uniform sampler2D uVelocitiesTexture;varying vec2 vUv;void main(){vec3 vel=texture2D(uVelocitiesTexture,vUv).xyz;gl_FragColor=vec4(vel*0.99,0.1);}";
...
var VelocityFieldKit = class extends RTDoubleBufferKit {
  ...
  constructor(edgeSize3d, pointGeo, positionsTextureUniform) {
    ...
    const phaseUniform = new Uniform4(0);
    const opacityUniform = new Uniform4(0.015);
    const uniforms = { uPhase: phaseUniform, uOpacity: opacityUniform };
    const plane2 = new Mesh2(getSharedRectangleGeometry(), new ShaderMaterial2({
      vertexShader: fullclip_vert_default,
...
var Atoms = class {
  ...
  constructor(edgeSize = 8) {
    ...
    const velocityKit = new VelocityFieldKit(16, geo, motionKit.outputTextureUniform);
    ...
    const pointsMat = new ShaderMaterial4({
      ...
      uniforms: {
        ...
        uParticleTexture: new Uniform6(getTempTexture())
      },
      depthWrite: true,
      depthTest: true
    });
    ...
    loader.load("sphere-sprite.png", (t) => {
      ...
      pointsMat.uniforms.uParticleTexture = new Uniform6(t);
    });
