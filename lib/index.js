...
var velocityField_frag_default = "uniform sampler2D uVelocitiesTexture;varying vec2 vUv;void main(){vec3 vel=texture2D(uVelocitiesTexture,vUv).xyz;gl_FragColor=vec4(vel*1.025,0.1);}";
