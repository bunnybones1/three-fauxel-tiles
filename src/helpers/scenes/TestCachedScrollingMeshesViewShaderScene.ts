...
import { getMaterial } from '../materials/materialLib'

import BaseTest2DScene from './BaseTest2DScene'

export default class TestCachedScrollingMeshesViewShaderScene extends BaseTest2DScene {
  ...
  constructor() {
    ...
    const ballGeo = new FibonacciSphereGeometry(0.1, 60)
    const ballMat = getMaterial('drywall')
