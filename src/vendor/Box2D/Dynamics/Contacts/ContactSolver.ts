...
export class ContactVelocityConstraint {
  ...
  points: VelocityConstraintPoint[] =
    VelocityConstraintPoint.MakeArray(maxManifoldPoints)
...
export class ContactSolver {
  ...
  m_positionConstraints: ContactPositionConstraint[] =
    ContactPositionConstraint.MakeArray(1024) // TODO: Settings
  m_velocityConstraints: ContactVelocityConstraint[] =
    ContactVelocityConstraint.MakeArray(1024) // TODO: Settings
  m_contacts!: Contact[]
  m_count = 0
